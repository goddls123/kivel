...
export const StackNav: React.FC = ({}) => {
  ...
  return (
    <Stack.Navigator initialRouteName={login ? 'Home' : 'Register'}>
      ...
      <Stack.Screen
        name="EnterChildInfo"
        component={EnterChildInfo}
        options={{headerShown: false}}
      />
      <Stack.Screen
        name="NurseryCaution"
        component={NurseryCaution}
        options={{headerShown: false, ...TransitionPresets.SlideFromRightIOS}}
      />
      <Stack.Screen
        name="NurseryCaution2"
        component={NurseryCaution2}
        options={{headerShown: false, ...TransitionPresets.SlideFromRightIOS}}
      />
      <Stack.Screen
        name="ChildTendency"
        component={ChildTendency}
        options={{headerShown: false, ...TransitionPresets.SlideFromRightIOS}}
      />
      <Stack.Screen
        name="ChildInfo"
      ...
      />
      <Stack.Screen
        name="AddCalendarPage"
        component={addCalendarPage}
        options={{headerShown: false}}
      />
      <Stack.Screen
        name="ScreeningResultEnroll"
        component={screeningResultEnroll}
        options={{headerShown: false}}
      />
      <Stack.Screen
        name="InviteTheraphist"
        component={inviteTheraphist}
        options={{headerShown: false}}
      />
