      ...
      <View
        ...
        <View style={{flex: 1, marginLeft: '12%', marginRight: '3%'}}>
          <Button
            text={'수정'}
            textColor={'#707070'}
            style={{backgroundColor: '#ededed', borderRadius: 50}}></Button>
        </View>
        <View style={{flex: 1, marginRight: '12%', marginLeft: '3%'}}>
          <Button
            text={'확인'}
            textColor={'white'}
            style={{backgroundColor: MAIN_COLOR, borderRadius: 50}}
            onPress={() => props.setModalView(false)}></Button>
        </View>
      </View>

      <Modal isVisible={mapModal} onBackdropPress={() => setMapModal(false)}>
        <View
          style={{
