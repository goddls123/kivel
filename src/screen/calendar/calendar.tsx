  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
          ...
          <View style={styles.calendarContainer}>
            <Calendar
              ...
              markedDates={{
                [selectedDate]: {
                  selected:
                    selectedDate != getDateYMD(new Date(), '-') ? true : false,
                  selectedColor: MAIN_COLOR,
                },
                '2021-10-25': {
                  selected: '2021-10-25' == selectedDate ? true : false,
                  selectedColor: MAIN_COLOR,
                  dots: [
        ...
        <View style={{margin: GLOBAL_MARGIN_HORIZON, marginBottom: 80}}>
          <Text
            ...
            {selectedDate == getDateYMD(new Date(), '-')
              ? '오늘'
              : selectedDate}
          </Text>
          {/* 일정 card */}
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('AddCalendarPage')}>
        <Image
